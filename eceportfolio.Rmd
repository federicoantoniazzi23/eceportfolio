...
ecefinal <-
  get_playlist_audio_features("", "7mATWeN6t4nSbVrqdppdr4") |>
  add_audio_analysis() |>
  mutate(
...
track_names <- ecefinal$`track name`
...
heatmaply(
  ...
  margins = c(50, 5, 5, 5), 
  k_row = 0,  
  xLabels = c("acousticness", "danceability", "energy", "instrumentalness", "liveness", "loudness", "mode")  
)
...
At the bottom are displayed some of the feature that characterize Espana Circo Este Song, such as liveness, loudness, danceability or notes. The graph shows for example that there a more major key songs, and that they lack in acousticness and instrumentalness, but almost all of the tracks have a high rate of time signature confidence.
